...
(function () {
  ...
  const shortDislike = async () => {
    ...
    const resultado = document.querySelectorAll(
    ...
    try {
      if (
        ...
        function limpiarHTML() {
          const buttonsClasicVideo =
            document.querySelectorAll('.clasic-mode-short');
        ...
        const addClasicVideo = () => {
          ...
          const buttonsClasicVideo1 =
            document.querySelectorAll('.clasic-mode-short');
          const colorButton = document.querySelectorAll(
            '#like-button > ytd-like-button-renderer > div > svg'
          );
